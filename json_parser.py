...
async def json_parser(file_path, metadata: dict = {}):
    ...
    for course in courses:
        ...
        course_info = f"{course['title']} - {course['info']}"
        full_text += course_info + "\n"

        # Example: Use a text splitter to break down the course info into chunks
        ...
        for chunk in chunks:
            parsed_file.add_chunk(Chunk(metadata={"filename": filename, "title": course['title'], **metadata}, text=chunk))
